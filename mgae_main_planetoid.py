...
def main():
    ...
    parser.add_argument('--decoder_mask', type=str, default='nmask', help='mask | nmask') # whether to use mask features
    ...
    split_edge = do_edge_split_direct(dataset)
    data = dataset[0]
    ...
    save_path_model = 'weight/mgaev2-' + args.use_sage + '_{}_{}_{}'.format(args.dataset, args.decoder_mask,args.de_v) + '_{}'.format(args.num_layers) \
                      + '_hidd{}-{}-{}-{}'.format(args.hidden_channels, args.keep_prob, args.decode_layers, args.decode_channels) + '_model.pth'
    save_path_predictor = 'weight/mgaev2' + args.use_sage + '_{}_{}_{}'.format(args.dataset, args.decoder_mask,args.de_v) + '_{}'.format(args.num_layers) \
                          + '_hidd{}-{}-{}-{}'.format(args.hidden_channels, args.keep_prob, args.decode_layers, args.decode_channels) + '_pred.pth'
